...
<body>
    ...
    <script>
        ...
        if (pflegegrad == 1) {
            ...
            document.getElementById('ambulant2').max = 125;
            ...
            document.getElementById('ambulant2').max = 761;
            ...
            document.getElementById('ambulant2').max = 1432;
            ...
            document.getElementById('ambulant2').max = 1778;
            ...
            document.getElementById('ambulant2').max = 2200;
        }
