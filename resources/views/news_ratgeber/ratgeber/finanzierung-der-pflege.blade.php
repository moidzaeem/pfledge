...
<body>
    ...
    <div class="news-und-section4">
        <div class="news-und-section5-list" style="background-color: #000000; color: #ffffff; margin-bottom: 1rem">
            <div class="section5-list-left">Leistungen 2024</div>
        ...
        <div class="news-und-section5-list" style="background-color: #f8fce2">
            ...
            <div class="news-info-popup news-info-popup1">
                ...
                <div class="popup-bottom">
                    ...
                    Pflegegrad 2. <br />
                    <br />
                    Die Pflegesachleistungen steigen zum 01.01.2024 um 5 Prozent, zum
                    01.01.2025 um 4,5 Prozent.
                </div>
        ...
        <div class="news-und-section5-list" style="background-color: #ebf8e9">
            ...
            <div class="news-info-popup news-info-popup2">
                ...
                <div class="popup-bottom">
                    ...
                    kann auch mit ambulanten Pflegesachleistungen kombiniert werden. Die
                    Höhe des Pflegegelds hängt wie die Pflegesachleistungen vom Grad der
                    Pflegebedürftigkeit (Pflegegrad) ab. <br />
                    <br />
                    Das Pflegegeld steigt zum 01.01.2024 um 5 Prozent, zum 01.01.2025 um
                    4,5 Prozent.
                </div>
                <button class="news-popup-btn">
                    Schließen <i class="fas fa-long-arrow-alt-right"></i>
        ...
        <div class="news-und-section5-list" style="background-color: #ebf8e9">
            <div class="section5-list-left">
                <span class="word-break">Verhinderungspflege</span> (§ 39 SGB XI)
                jährl. <br />
                - inkl. 806 EUR Aufstockung Kurz.-Pfl. <br />
                - Std. Lohn - Budget f. nahe Verwandte <br />
                - Rest f. Fahrtkosten ohne KZP-Aufst. <br />
                - Rest f. Fahrtkosten ohne KZP-Aufst. <br />
                (alle außer Kinder & Jugendliche mit PG 4 o. 5 bis 25 Jahre)
            ...
            <div class="news-info-popup news-info-popup5">
                ...
                <div class="popup-bottom">
                    ...
                    werden. <br />
                    <br />
                    Diese Voraussetzung der sogenannten Vorpflegezeit entfällt ab
                    01.01.2024 für Pflegebedürftige mit dem Pflegegrad 4 oder 5, sofern
                    sie noch nicht das 25. Lebensjahr vollendet haben. Ab dem 01.07.2025
                    ändert sich das ebenso für alle Pflegebedürftigen ab dem Pflegegrad
                    2. <br />
                    <br />
                    ...
                    bis zu sechs Wochen in Höhe bis zu 1.612 Euro je Kalenderjahr.
                    Zusätzlich kann die Hälfte des Leistungsbetrags der Kurzzeitpflege
                    (also bis zu 806 Euro im Kalenderjahr) für die Verhinderungspflege
                    genutzt werden. <br />
                    <br />
                    ...
                    getrennten Töpfen, die sich teilweise übertragen lassen, sollen
                    beide Pflegeleistungen aus dem gemeinsamen Entlastungsbudget
                    finanziert werden. <br />
                    Für die meisten Pflegebedürftigen tritt das Entlastungsbudget erst
                    zum 01.01.2025 in Kraft und beträgt dann 3.539 Euro. Junge
                    Pflegebedürftige bis 25 Jahre mit Pflegegrad 4 oder Pflegegrad 5
                    können bereits schon ab 2024 auf ein vorgezogenes Entlastungsbudget
        ...
        <div class="news-und-section5-list" style="background-color: #ebf8e9">
            <div class="section5-list-left">
                Kurzzeitpflege (§ 42 SGB XI) jährl. inkl. Aufstockung
                <span class="word-break">Verhinderungspflege</span> <br />
                (alle außer Kinder & Jugendliche mit PG 4 o. 5 bis 25 Jahre)
            ...
            <div class="news-info-popup news-info-popup6">
                <div class="popup-top">
                    <i class="fa fa-eye"></i> 4d. Kurzzeitpflege (§ 42) jährl. inkl.
                    Aufstockung Verhinderungspflege
                    <i class="fa-solid fa-circle-xmark close-popup"></i>
                </div>
                <div class="popup-bottom">
                    ...
                    getrennten Töpfen, die sich teilweise übertragen lassen, sollen
                    beide Pflegeleistungen aus dem gemeinsamen Entlastungsbudget
                    finanziert werden. Für die meisten Pflegebedürftigen tritt das
                    Entlastungsbudget erst zum 01.01.2025 in Kraft und beträgt dann
                    3.539 Euro. Junge Pflegebedürftige bis 25 Jahre mit Pflegegrad 4
                    oder Pflegegrad 5 können bereits schon ab 2024 auf ein vorgezogenes
                    Entlastungsbudget von 3.386 Euro zugreifen.
                </div>
                <button class="news-popup-btn">
                    Schließen <i class="fas fa-long-arrow-alt-right"></i>
                </button>
        ...
        <div class="news-und-section5-list" style="background-color: #ebf8e9">
            <div class="section5-list-left">
                Gemeinsamer Jahresbetrag (§ 42a SGB XI) jährl. <br />
                - Kurzzeitpflege (§ 42) <br />
                - <span class="word-break">Verhinderungspflege</span> (§ 39) <br />
                - Std. Lohn - Budget f. nahe Verwandte <br />
                Rest f. Fahrtkosten <br />
                (nur Kinder & Jugendliche mit PG 4 oder 5 bis 25 Jahre)
        ...
        <div class="news-und-section5-list" style="background-color: #ebf8e9">
            <div class="section5-list-left">
                <span class="word-break">Kombinationsleistung</span> (§ 38 SGB XI)
                jährl.
            </div>
            <div class="section5-list-right">
                <div style="font-size: 33.5px; font-weight: 700">-</div>
        ...
        <div class="news-und-section5-list" style="background-color: #ebf8e9">
            <div class="section5-list-left">
                Umwandlung 40% ambulanter<span class="word-break">Sachleistungsbetrag</span>
                (§ 45a SGB XI) mtl.
            </div>
            <div class="section5-list-right">
                <div style="font-size: 33.5px; font-weight: 700">-</div>
        ...
        <div class="news-und-section5-list" style="background-color: #ebf8e9">
            ...
            <div class="news-info-popup news-info-popup12">
                ...
                <div class="popup-bottom">
                    ...
                    bis zu 4.000 Euro für notwendige Veränderungen ihrer Wohnung bei der
                    ...
                    4.000 Euro erhalten, insgesamt sind also bis zu 16.000 Euro möglich.
        ...
        <div class="news-und-section5-list" style="background-color: #f3f3f3">
            ...
            <div class="news-info-popup news-info-popup13">
                ...
                <div class="popup-bottom">
                    ...
                    gewährt ihnen die Pflegeversicherung einen Zuschuss in Höhe von 125
                    Euro monatlich. <br />
                    <br />
