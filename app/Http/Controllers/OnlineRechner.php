...
class OnlineRechner extends Controller
{
    ...
    public function calculationForThirdPage(Request $request)
    {
        ...
        if ($pflegegrad == 1) {
            $teilstattext = "Bei Pflegegrad 1 besteht kein Anspruch auf teilstationäre Pflege (Entlastungsbetrag in Höhe von 125 EUR).";
            $vollstattext = "Hinweis: Bei vollstationärer Pflege, also der Unterbringung im Pflegeheim besteht kein Anspruch auf Pflegegeld.<br />Angegeben ist hier nur der Vollständigkeit halber die vom Pflegegrad abhängige Kostenübernahme der Pflegekasse bei Heimunterbringung.<br />Bei Pflegegrad 1 und vollstationärer Pflege besteht kein Anspruch auf Kostenübernahme.";
        } else {
    ...
    { // Get values from the request
        ...
        // Modul 2
        $modul2_1 = $request->input('modul2_1');
        $modul2_2 = $request->input('modul2_2');
        $modul2_3 = $request->input('modul2_3');
        $modul2_4 = $request->input('modul2_4');
        $modul2_5 = $request->input('modul2_5');
        $modul2_6 = $request->input('modul2_6');
        $modul2_7 = $request->input('modul2_7');
        $modul2_8 = $request->input('modul2_8');
        $modul2_9 = $request->input('modul2_9');
        $modul2_10 = $request->input('modul2_10');
        $modul2_11 = $request->input('modul2_11');
        ...
        $modul5_3 = $request->input('modul5_3');
        $modul5_4 = $request->input('modul5_4');
        $modul5_5 = $request->input('modul5_5');
        $modul5_6 = $request->input('modul5_6');
        $modul5_7 = $request->input('modul5_7');
        $modul5_8 = $request->input('modul5_8');
        $modul5_9 = $request->input('modul5_9');
        $modul5_10 = $request->input('modul5_10');
        $modul5_11 = $request->input('modul5_11');
        $modul5_12 = $request->input('modul5_12');
        $modul5_13 = $request->input('modul5_13');
        $modul5_14 = $request->input('modul5_14');
        $modul5_15 = $request->input('modul5_15');
        $modul5_16 = $request->input('modul5_16');

        // Modul 6
        $modul6_1 = $request->input('modul6_1');
        $modul6_2 = $request->input('modul6_2');
        $modul6_3 = $request->input('modul6_3');
        $modul6_4 = $request->input('modul6_4');
        $modul6_5 = $request->input('modul6_5');
        $modul6_6 = $request->input('modul6_6');
